...
<head>
    ...
    <title>B-FORMS NOTIFICATION</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <img src="{{ asset('/images/logonobg.png') }}" alt="bforms-logo" class="product-img" height="100" width="100">
        ...
        <div class="content">
            <div class="stats">
                ...
                @if(isset($buttons) && is_array($buttons) && count($buttons) > 0)
                    ...
                    @endforeach
                @else
                    <a href="{{ $url }}" class="button">View B-FORM</a>
                @endif
                <br>
                ...
                <br>
                © {{ date('Y') }} BEVI IT System. All rights reserved.
            </div>
