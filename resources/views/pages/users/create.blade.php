                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {{ html()->select('department_id', $departments,'')->class(['form-control', 'form-control-sm text-uppercase', 'is-invalid' => $errors->has('department_id')]) }}
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {{ html()->select('position_id', $positions,'')->class(['form-control', 'form-control-sm text-uppercase', 'is-invalid' => $errors->has('position_id')]) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-switch custom-switch-purple">
                                ...
                                <label class="custom-control-label" for="costcenterSwitch">
                                    <span id="switch-text">
                                        {{ old('cost_center') == 1 ? __('(Yes)') : __('(No)') }}
                                    </span>
                                </label>
                            </div>
