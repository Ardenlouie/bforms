@canany(['bforms scm', 'bforms finance'])
    <a href="{{ route('export.psrf') }}" class="btn btn-success float-right"><i class="fa fa-file-export"></i> Download Refreshable File</a>
@endcanany
            ...
            <tr>
                ...
                <td class="align-middle text-center">
                    ...
                    @php
                        ...
                        $brands = \App\Models\User::whereIn('id', $my_form->brands ?? [])->get();
                        $group_brands = \App\Models\User::whereIn('id', $my_form->group_brands ?? [])->get();
                    @endphp
