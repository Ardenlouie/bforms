...
<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-3">
            ...
            <div class="col-6">
                <h4>Name: <b>{{ ($forms->model->pca_form->name ?? '' )}}</b></h4>
                <h4>Cost Center: <b>{{ ($forms->model->pca_form->cost_center ?? '' )}}</b></h4>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="table-responsive mb-3">
                <table class="table table-striped text-center" id="summaryTable">
                    ...
                    <tbody>
                        @foreach($forms->model->pcl_form_item()->get() as $index => $item)
                            <tr>
                                <td>{{ $index + 1 }}</td>
        ...
        <div class="row">
            <div class="col-12 mb-3">
                ...
                <h2>Amount Returned: <b>₱{{  number_format($forms->model->balance ?? 0.00 , 2) }}</b></h2>
                <h2>Liquidated by: <b>{{ $forms->model->pca_form->name ?? '' }}</b></h2>
            </div>
            ...
            <div class="col-6 text-right">
                @if($forms->status == 'approved')
                    ...
                    @else
                        ...
                        <a type="button" href="{{route( 'pcl.xml', encrypt($forms->model->id) )}}" class="btn bg-gradient-lightblue" style="margin-right: 5px;">
