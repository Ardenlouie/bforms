    ...
    <div class="card-body">
        ...
        <div class="col-md-12">
            <div class="table-responsive mb-3">
                <table class="table table-striped text-center" id="summaryTable">
                    ...
                    <tbody>
                        @foreach($forms->model->pca_form_item()->get() as $index => $item)
                            <tr>
                                <td>{{ $index + 1 }}</td>
        ...
        <div class="row">
            <div class="col-12 mb-3">
                <h2>Total Amount: <b>₱{{  number_format($forms->model->total_amount ?? 0.00 , 2) }}</b></h2>
                <h2>Received by: <b>{{ $forms->model->name ?? '' }}</b></h2>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-6 text-right">
                ...
                @endphp
                    @if(!empty($pca_pcl))
                        <small class="form-text text-muted mb-3">
                            Petty Cash Liquidation has been created: 
                        </small>
                        <label class="form-text text-bold text-xl">
                            {{$pca_pcl->control_number}}
                        </label>
                    @else
