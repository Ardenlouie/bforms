...
<main>
    ...
    <table class="info-table">
        <tr>
            <td class="label">Payable to:</td>
            <td>{{ $forms->model->payable }}</td>
            <td class="label">Department:</td>
            <td>{{ $forms->model->department->name }}</td>
        <tr>
        <tr>
            <td class="label">Purpose:</td>
            <td>{{ $forms->model->purpose }}</td>
            <td class="label">Cost Center:</td>
            <td>{{ $forms->model->cost_center }}</td>
        <tr>
        <tr>
            <td class="label">Instructions:</td>
            <td>{{ $forms->model->instructions }}</td>
    ...
    <div class="header">
        <h2>Amount</h2>
        <h1>
            {{  number_format($forms->model->amount ?? 0.00 , 2) }} {{ $forms->model->currency }}
        </h1>
    </div>
