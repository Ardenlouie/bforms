<form action="{{ route('update.pca',encrypt($all_form->id)) }}" method="POST" id="update_pca">
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" form="update_pca" value="{{ $all_form->model->name }}"> 
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <select id="cost_center" name="cost_center" class="form-control" value="{{ $all_form->model->cost_center }}" style="width: 100%;" form="update_pca"></select>
    ...
    <div class="card-footer text-right">
        <input type="hidden" id="status" name="status" form="update_pca" value="pending">
