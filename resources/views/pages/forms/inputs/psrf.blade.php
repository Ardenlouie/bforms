        ...
        <div class="row">
            ...
            <!-- <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="date_submitted" form="add_psrf"> 
                    <small class="text-danger">{{$errors->first('date_submitted')}}</small>
                </div>
            </div> -->
        </div>
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="program_date" form="add_psrf"> 
