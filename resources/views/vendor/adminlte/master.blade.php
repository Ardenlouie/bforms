...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/logonobg.png')}}" />
    ...
    <style>
        /* Hide sidebar by default on large screens if using Top Nav */
        ...
        /* On Mobile: Show sidebar and adjust Top Nav */
        @media (max-width: 991.98px) {
            .layout-top-nav .main-sidebar {
                display: block !important;
            }
            
            /* Optional: Hide the top navbar links to save space since they are now in the sidebar */
            .layout-top-nav .navbar-nav {
                display: block;
            }
        }
    </style>
