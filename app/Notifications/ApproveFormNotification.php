...
class ApproveFormNotification extends Notification
{
    use Queueable;
    use SettingTrait;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $introLines = [
            "Your ".$this->all_forms->form->name." with number \"<strong>{$this->all_forms->model->control_number}</strong>\" has been APPROVED!"
        ];
        $outroLines = [
